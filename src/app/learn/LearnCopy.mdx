...
The source code of this website is public and [hosted on GitHub](https://github.com/flsilva/nexar.flsilva.com).
...
Do you have a great way to test Next.js App Router apps? Please [share it](https://github.com/flsilva/nexar.flsilva.com/discussions) with us.
...
I want to build more apps using it to keep improving it, and I would love to evolve Nexar collectively, exchanging knowledge with the community. To share your thoughts, please [open a GitHub discussion](https://github.com/flsilva/nexar.flsilva.com/discussions). Let's talk about it.

### About versioning the architecture

The _`nexar.flsilva.com/learn`_ page will always show the latest version of the architecture.

I plan to keep using and making several minor improvements to Nexar. I'm calling the present version a beta version to make these improvements possible without explicitly versioning them in the next several months (although any changes will always be visible in Nexar's [public repo](https://github.com/flsilva/nexar.flsilva.com/)). I also intend to provide more detailed explanations of specific concepts and cover OpenTask's implementation in greater depth.
