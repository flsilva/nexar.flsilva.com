...
- Dive into the Nexar [documentation](https://nexar.flsilva.com/learn).
...
- [Join the discussion](https://github.com/flsilva/nexar.flsilva.com/discussions) and share your thoughts.
